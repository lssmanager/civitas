CREATE TABLE IF NOT EXISTS "crm_role_mappings" (
  ...
  CONSTRAINT "crm_role_mappings_organization_role_name_unique" UNIQUE("organization_role_name")
);
CREATE UNIQUE INDEX IF NOT EXISTS "crm_role_mappings_role_name_unique" ON "crm_role_mappings" USING btree ("organization_role_name");
